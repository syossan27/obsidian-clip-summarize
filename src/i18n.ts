...
export const translations: Record<Language, Messages> = {
  en: {
    settings: {
      ...
      watchFolderDesc:
        'Folder to auto-summarize (empty = none, * = all folders, or specify folder)',
  ...
  ja: {
    settings: {
      ...
      watchFolderDesc: '自動要約の対象フォルダ（空欄=対象なし、*=全フォルダ、またはフォルダ指定）',
  ...
  zh: {
    settings: {
      ...
      watchFolderDesc: '自动摘要的目标文件夹（空=无，*=所有文件夹，或指定文件夹）',
  ...
  es: {
    settings: {
      ...
      watchFolderDesc:
        'Carpeta para resumir automáticamente (vacío = ninguna, * = todas, o especificar carpeta)',
  ...
  fr: {
    settings: {
      ...
      watchFolderDesc:
        'Dossier à résumer automatiquement (vide = aucun, * = tous, ou spécifier un dossier)',
  ...
  de: {
    settings: {
      ...
      watchFolderDesc:
        'Ordner für automatische Zusammenfassung (leer = keine, * = alle, oder Ordner angeben)',
  ...
  ko: {
    settings: {
      ...
      watchFolderDesc: '자동 요약 대상 폴더 (비움=없음, *=모든 폴더, 또는 폴더 지정)',
  ...
  pt: {
    settings: {
      ...
      watchFolderDesc:
        'Pasta para resumir automaticamente (vazio = nenhuma, * = todas, ou especificar pasta)',
  ...
  ru: {
    settings: {
      ...
      watchFolderDesc: 'Папка для автоматического резюме (пусто = нет, * = все, или указать папку)',
  ...
  it: {
    settings: {
      ...
      watchFolderDesc:
        'Cartella da riassumere automaticamente (vuoto = nessuna, * = tutte, o specificare cartella)',
  ...
  ar: {
    settings: {
      ...
      watchFolderDesc: 'المجلد للتلخيص التلقائي (فارغ = لا شيء، * = الكل، أو تحديد مجلد)',
  ...
  hi: {
    settings: {
      ...
      watchFolderDesc:
        'स्वचालित सारांश के लिए फ़ोल्डर (खाली = कोई नहीं, * = सभी, या फ़ोल्डर निर्दिष्ट करें)',
  ...
  nl: {
    settings: {
      ...
      watchFolderDesc:
        'Map voor automatische samenvatting (leeg = geen, * = alle, of map specificeren)',
  ...
  tr: {
    settings: {
      ...
      watchFolderDesc: 'Otomatik özet için klasör (boş = hiçbiri, * = tümü, veya klasör belirtin)',
  ...
  pl: {
    settings: {
      ...
      watchFolderDesc:
        'Folder do automatycznego streszczenia (puste = żaden, * = wszystkie, lub określ folder)',
